 ...
 * @Desc: 官方案例演示：会话窗口JOIN，基于事件时间EventTime，设置时间间隔grap为：1秒
 */
public class _08_03SessionWindowJoinDemo {
...
*/
        ...
        // 5. 触发执行-execute
        env.execute(_08_03SessionWindowJoinDemo.class.getSimpleName()) ;
