 ...
 * @Author: Jface
 * @Date: 2021/9/8 17:25
 * @Desc: 窗口统计案例演示：时间滑动窗口（Time Sliding  Window），实时交通卡口车流量统计
 */
public class _03StreamTimeSlidingWindow {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> windowDataStream = inputDataStream
                ...
                //TODO: 3.按照卡口分组
                .keyBy(0)
                //TODO: 4.设置滑动窗口,窗口时间为10秒，滑动时间为 5秒
        ...
        //5.触发执行-execute
        env.execute(_03StreamTimeSlidingWindow.class.getName());
