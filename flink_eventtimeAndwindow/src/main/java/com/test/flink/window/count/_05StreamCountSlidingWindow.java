 ...
 * @Author: Jface
 * @Date: 2021/9/8 17:42
 * @Desc: 窗口统计案例演示：滑动计数窗口（Tumbling Count Window)，数字累加求和统计
 */
public class _05StreamCountSlidingWindow {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> windowDataStream = inputDataStream
                ...
                //TODO: 3.设置计数滚动窗口，size=5 slide=2
                .countWindowAll(5, 2)
                //TODO: 4.设置窗口数据聚合
                .sum(1);
        //4.输出结果-sink
        ...
        //5.触发执行-execute
        env.execute(_05StreamCountSlidingWindow.class.getName());
