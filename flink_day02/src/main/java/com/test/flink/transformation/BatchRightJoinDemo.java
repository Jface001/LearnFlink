 ...
 * @Author: Jface
 * @Date: 2021/9/6 11:23
 * @Desc: Flink 框架中批处理实现两个数据集关联分析：RightJoin
 */
public class BatchRightJoinDemo {
    public static void main(String[] args) throws Exception {
        ...
        //TODO:指定关联数据集
        JoinOperator<Tuple2<Integer, String>, Tuple2<Integer, String>, String> resultDataSet = nameDataSet.rightOuterJoin(cityDataSet)
                //TODO:指定条件
                .where(0).equalTo(0)
                //TODO:选择字段
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, String>() {
                    ...
                    public String join(Tuple2<Integer, String> name, Tuple2<Integer, String> city) throws Exception {
                        ...
                        //TODO:返回结果
                        return city.f0 + "," + stuName + "," + city.f1;
                    }
                });
