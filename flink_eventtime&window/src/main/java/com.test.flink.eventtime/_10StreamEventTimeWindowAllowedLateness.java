...
public class _10StreamEventTimeWindowAllowedLateness {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> resultDataStream = tupleDataStream
                ...
                //TODO:4、3 设置延迟数据最大时间，注意此时窗口已经触发计算，但是保留
                .allowedLateness(Time.seconds(5))
                //TODO:4、4 设置 已经超过允许最大延迟时间的数据进入侧边栏
                .sideOutputLateData(outputTag)
                //TODO:4、5 设置窗口数据聚合，编码实现如何计算窗口数据
        ...
        //TODO:获取超过允许最大时间的数据，侧边流
        DataStream<Tuple2<String, Integer>> lateDataStream = resultDataStream.getSideOutput(outputTag);
        lateDataStream.print();


        // 5. 触发执行-execute
        env.execute(_10StreamEventTimeWindowAllowedLateness.class.getName());
