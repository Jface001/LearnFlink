 ...
 * @Author: Jface
 * @Date: 2021/9/6 11:29
 * @Desc: Flink 框架中批处理实现两个数据集关联分析：FUllJoin
 */
public class BatchFullJoinDemo {
    public static void main(String[] args) throws Exception {
        ...
        //TODO:指定数据集
        JoinOperator<Tuple2<Integer, String>, Tuple2<Integer, String>, String> resultDataSet = nameDataSet.fullOuterJoin(cityDataSet)
                //TODO:指定关联条件
                .where(0).equalTo(0)
                //TODO:指定字段
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, String>() {
                    ...
                    public String join(Tuple2<Integer, String> name, Tuple2<Integer, String> city) throws Exception {
                        ...
                        return userId + "," + userName + "," + cityName;
                    }
                });
